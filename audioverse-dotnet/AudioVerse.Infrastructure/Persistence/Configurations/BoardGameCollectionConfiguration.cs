...
public class BoardGameCollectionConfiguration : IEntityTypeConfiguration<BoardGameCollection>
{
    public void Configure(EntityTypeBuilder<BoardGameCollection> builder)
    {
